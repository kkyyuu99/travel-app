// Tokyo Travel PWA — Service Worker
// 캐시 버전을 올리면 모든 사용자가 새 번들을 받습니다.
const CACHE_VERSION = 'v1';
const STATIC_CACHE = `tokyo-static-${CACHE_VERSION}`;
const RUNTIME_CACHE = `tokyo-runtime-${CACHE_VERSION}`;
...
// Network First를 적용할 외부 API (실시간 데이터)
